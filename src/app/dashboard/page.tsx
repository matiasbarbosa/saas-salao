...
const MOCK_CATEGORIES = [
    ...
    { id: "4", name: "Massagem", icon: "💆‍♀️", color: "bg-emerald-500/10 text-emerald-600" },
    { id: "5", name: "Depilação", icon: "🦵", color: "bg-amber-500/10 text-amber-600" },
];

const MOCK_FEATURED_SALONS = [
    { id: "s1", name: "Studio Elegance", type: "Salão Misto", rating: 4.8, distance: "1.2 km", image: "https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&q=80&w=400&h=300" },
